...
public class RefereeNotFoundException extends RuntimeException {
    ...
    public static final String NOT_FOUND_WITH_FIRSTNAME_AND_LASTNAME = "Referee with name = \"%s %s\" has not been found";
    public static final String NOT_FOUND_WITH_ID = "Referee with id = %d has not been found";
